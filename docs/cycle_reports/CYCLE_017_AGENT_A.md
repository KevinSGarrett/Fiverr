...
- Final local commit SHA (post-commit): `git rev-parse HEAD` (captured at final verification)
- Final pushed head SHA (post-push): `git rev-parse HEAD` (captured at final verification)
