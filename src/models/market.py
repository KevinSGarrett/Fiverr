...
class Keyword(
    ...
    is_discovery: Mapped[bool] = mapped_column(Boolean, default=False, nullable=False, index=True)
    ...
    discovered_in_run: Mapped[str | None] = mapped_column(String(64), nullable=True)
    discovery_evaluated: Mapped[bool] = mapped_column(Boolean, default=False, nullable=False, index=True)
