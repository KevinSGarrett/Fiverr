...
class TestS79CoverageUplift:
    ...
    def test_stage16_intact_after_c073(self) -> None:
        ...
        # Widened for the llm_niche_expansion wiring + cost-accounting fix (SCRUM-1106,
        # Codex P2 on PR #181) - this guard exists to catch accidental truncation, not
        # to block legitimate growth.
        assert 295 <= line_count <= 440
