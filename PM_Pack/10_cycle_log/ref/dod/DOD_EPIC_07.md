...
### Definition of Done
- [ ] Discovery cycle loop runs without error
- [ ] Hypothesis budget respected
...
### Definition of Done
- [ ] All 4 hypothesis modes generate valid hypotheses
- [ ] Each mode respects min_confidence threshold
...
### Definition of Done
- [ ] Discovery outcomes scored and fed back into confidence
- [ ] Promoted keywords get is_discovery=True
- [ ] gold_threshold promotion logic works
...
### Definition of Done
- [ ] Promoted discovery keywords enter main collection pipeline
- [ ] Keyword.discovery_mode set correctly
