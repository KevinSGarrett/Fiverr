CYCLE 078 — Agent E: Live Validation / External Signals / Prompt Factory
...
- PM_Pack/automation/prompts/validated/CYCLE_078_VALIDATION_REPORT.json
...
Relevant files:
- PM_Pack/automation/prompt_contracts/CYCLE_078_*.contract.json
- PM_Pack/automation/prompt_contracts/CYCLE_078_LINEAGE_REPORT.md
...
- Files: PM_Pack/automation/prompt_contracts/CYCLE_078_*.contract.json, PM_Pack/automation/prompt_contracts/CYCLE_078_LINEAGE_REPORT.md
- Validation: Run targeted checks and record evidence.
...
- Files: PM_Pack/automation/prompts/validated/CYCLE_078_VALIDATION_REPORT.json
- Validation: Run targeted checks and record evidence.
...
Write final report to: docs/cycle_reports/CYCLE_078_AGENT_E.md
